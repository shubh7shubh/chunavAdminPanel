...
const OrderPaymentAndRefundModal = ({ buttonText, modalTitle, products }) => {
            ...
            >
                <Box sx={style}>
                    ...
                    <div className="flex m-7 ">
                        <p className="mr-9">Order Number <span className='text-gray-500'>#9348fjr73</span></p>
                        <p className="mr-2">Order Date</p>
                        <span className="text-gray-400 mr-12"> 01-Jan-2023 - 03:21 pm</span>
                        <p className="mr-2">Tracking Id</p>
                        <span className="text-blue-600 mr-12">IN63545115055CG</span>
                    </div>
                    ...
                    <div className="flex justify-end gap-12 my-7">
                        ...
                        <button
                            ...
                            className=" px-7 font-medium text-red-600 border-2 border-red-600  rounded-lg py-3  items-center transition transform active:scale-95 duration-200  "
                        >
...
export default OrderPaymentAndRefundModal;
